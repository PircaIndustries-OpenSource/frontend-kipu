...
export class IotMonitoringApiService {
  ...
  private readonly baseUrl = `${environment.kipuApiHost}${environment.kipuApiBaseUrl}`;
  ...
  getAllSeismicSensors(): Observable<SeismicEntity[]> {
    return this.httpClient
      .get<SeismicResponse>(
        `${this.baseUrl}${this.ioTMonitoringEndpoint}${this.seismicControlEndpoint}`,
      )
  ...
  getAllConcreteSensors(): Observable<ConcreteEntity[]> {
    return this.httpClient
      .get<ConcreteResponse>(
        `${this.baseUrl}${this.ioTMonitoringEndpoint}${this.concreteCuringEndpoint}`,
      )
  ...
  getAllGeolocalizationPoints(): Observable<GeolocalizationEntity[]> {
    return this.httpClient
      .get<GeolocalizationResponse>(
        `${this.baseUrl}${this.ioTMonitoringEndpoint}${this.geolocalizationEndpoint}`,
      )
